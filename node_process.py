...
if __name__ == '__main__':
    ...
    argparser.add_argument('--dataset', type=int, help='dataset Name (possibilities : CoraGraphDataset, CiteseerGraphDataset, PubmedGraphDataset... (see https://docs.dgl.ai/en/2.0.x/api/python/dgl.data.html#node-prediction-datasets)', default=CoraGraphDataset)
